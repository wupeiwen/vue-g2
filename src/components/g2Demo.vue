 ...
 * @Last Modified time: 2018-09-20 13:55:21
 */
<template>
  <div>
    ...
    <div style="width: 300px;margin: auto;">
      <g2-liquidfill :id="'liquidfill'" :height="300" :maxValue="1" :isPercent="true" :data="[{ name: '中国', value: 0.45 }]" :axisName="{name:'国家', value:'GDP占比'}"></g2-liquidfill>
    </div>
  </div>
</template>
